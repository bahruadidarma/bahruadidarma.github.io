      ...
      Swal.fire("Awas aja kalau kamu bohong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            confirmButtonText: `Sayang dongg`,
            denyButtonText: `Idih najis`,
          }).then((result) => {
            ...
            if (result.isConfirmed) {
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('yahhh , emang ga kangen sama aku ya', '', 'error').then(function () {
                          Swal.fire('Yaudah oke dehh :((')
                        })
                      }
                    })
                  })
              ...
              Swal.fire(`Ihh jahat banget :(`, '', 'error').then(function () {
                Swal.fire('Yaudah dehh makasih ya :((')
              })
            }
          })
        })
